...
private object CommonMainDrawable0 {
  ...
  public val ic_profile_logout: DrawableResource by 
      lazy { init_ic_profile_logout() }

  public val ic_profile_timetable: DrawableResource by 
      lazy { init_ic_profile_timetable() }

  public val ic_profile_win: DrawableResource by 
      lazy { init_ic_profile_win() }
...
internal fun _collectCommonMainDrawable0Resources(map: MutableMap<String, DrawableResource>) {
  ...
  map.put("ic_profile_win", CommonMainDrawable0.ic_profile_win)
...
internal val Res.drawable.ic_profile_btn_back: DrawableResource
  get() = CommonMainDrawable0.ic_profile_btn_back

private fun init_ic_profile_btn_back(): DrawableResource =
    org.jetbrains.compose.resources.DrawableResource(
  "drawable:ic_profile_btn_back",
    setOf(
      org.jetbrains.compose.resources.ResourceItem(setOf(),
    "composeResources/educateyou.composeapp.generated.resources/drawable/ic_profile_btn_back.xml", -1, -1),
    )
)

internal val Res.drawable.ic_profile_logout: DrawableResource
  get() = CommonMainDrawable0.ic_profile_logout

private fun init_ic_profile_logout(): DrawableResource =
    org.jetbrains.compose.resources.DrawableResource(
  "drawable:ic_profile_logout",
    setOf(
      org.jetbrains.compose.resources.ResourceItem(setOf(),
    "composeResources/educateyou.composeapp.generated.resources/drawable/ic_profile_logout.xml", -1, -1),
    )
)

internal val Res.drawable.ic_profile_timetable: DrawableResource
  get() = CommonMainDrawable0.ic_profile_timetable

private fun init_ic_profile_timetable(): DrawableResource =
    org.jetbrains.compose.resources.DrawableResource(
  "drawable:ic_profile_timetable",
    setOf(
      org.jetbrains.compose.resources.ResourceItem(setOf(),
    "composeResources/educateyou.composeapp.generated.resources/drawable/ic_profile_timetable.xml", -1, -1),
    )
)

internal val Res.drawable.ic_profile_win: DrawableResource
  get() = CommonMainDrawable0.ic_profile_win

private fun init_ic_profile_win(): DrawableResource =
    org.jetbrains.compose.resources.DrawableResource(
  "drawable:ic_profile_win",
    setOf(
      org.jetbrains.compose.resources.ResourceItem(setOf(),
    "composeResources/educateyou.composeapp.generated.resources/drawable/ic_profile_win.xml", -1, -1),
    )
)
